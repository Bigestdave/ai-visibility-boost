const features = [
  "Find exactly which buyer questions AI is getting wrong about you",
  "Build 1–2 comparison pages (you vs. your biggest competitors)",
  "Create the case study and use-case pages AI tools look for",
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.1fr] gap-12 items-start">
          ...
          <div className="reveal below-fold">
            ...
            <p className="text-lg-body !text-white/60 mb-5">
              A fixed-price sprint for B2B companies that want to stop losing deals to competitors in AI search. We fix your site so ChatGPT, Perplexity, and other AI tools recommend you first.
            </p>
